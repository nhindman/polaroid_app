...
[![Build Status](https://travis-ci.org/nhindman/polaroid.svg?branch=master)](https://travis-ci.org/nhindman/polaroid) [![Dependency Status](https://david-dm.org/nhindman/polaroid.svg)](https://david-dm.org/nhindman/polaroid) [![devDependency Status](https://david-dm.org/nhindman/polaroid/dev-status.svg)](https://david-dm.org/nhindman/polaroid#info=devDependencies)
...
## Release History
 * 2014-05-12   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)